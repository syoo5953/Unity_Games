...
public class QuestUIScript : Singleton<QuestUIScript> {
    ...
    {
        Debug.Log(GameManager.Instance.objectPool.GetObject("QuestListSlot").GetComponent<QuestSlot>().quest);
    }
    ...
    public void UpdateObjectives(Quest _quest) {
        ...
        Debug.Log("No of questSlots in UIScript = " + questSlots.Count);
        
        if(questSlot.quest.collectObjectives == null)
        {
